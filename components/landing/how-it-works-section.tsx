  ...
  const steps = [
    {
      ...
      description: "Secure OAuth connection. We never store your password. Takes 30 seconds.",
    },
    {
      icon: Sliders,
      step: "02",
      title: "Set Your Voice",
      description: "Answer a few questions about your tone and style. Our AI learns how you communicate.",
    },
    {
      icon: Sparkles,
      step: "03",
      title: "Activate Automation",
      description: "Choose which posts to monitor. Set DM triggers. Review or auto-approve replies.",
    },
    {
      icon: Coffee,
      step: "04",
      title: "Relax & Grow",
      description: "Watch engagement happen automatically. Check analytics. Focus on creating content.",
    },
  ]

  return (
    <section id="how-it-works" className="border-t border-border bg-secondary/10 py-20 sm:py-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="text-center">
          <p className="text-sm font-medium text-primary">How It Works</p>
          <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">From setup to autopilot in 5 minutes</h2>
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            No complex configurations. No learning curve. Just connect and let AI handle the rest.
          </p>
        </div>
