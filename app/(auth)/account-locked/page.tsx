    ...
    <CenteredShell>
      <div className='w-full max-w-[440px] rounded-2xl border border-warning/25 bg-[#1a150a] p-12 text-center shadow-xl shadow-black/40'>
        ...
        <div className='mx-auto mb-6 h-16 w-16 rounded-full border-2 border-warning/30 bg-warning/15 flex items-center justify-center'>
          <svg className='h-7 w-7 text-warning' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.75' strokeLinecap='round' strokeLinejoin='round'>
        ...
        <div className='mt-6 flex items-start gap-3 rounded-xl border border-border bg-card p-4 text-left'>
          ...
          <div>
            <p className='text-sm font-medium text-foreground'>Account unlocks automatically</p>
            <p className='text-xs text-muted-foreground mt-0.5'>Your account will be unlocked in approximately 30 minutes. No action required.</p>
          </div>
        </div>
