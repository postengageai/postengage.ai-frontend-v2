...
function IconCircle({
  ...
  return (
    <div
      className={`mx-auto mb-6 h-16 w-16 rounded-full border-2 ${color} flex items-center justify-center`}
    >
      {children}
    </div>
  );
        ...
        {isSubmitted ? (
          ...
          <div className='w-full max-w-[440px] rounded-2xl border border-border bg-card p-5 sm:p-12 text-center shadow-xl shadow-black/40'>
            ...
            <p className='mt-3 text-sm text-muted-foreground leading-relaxed'>
              If an account exists with this email, we&apos;ve sent a reset
              link. Check spam if you don&apos;t see it.
            </p>
