      ...
      <div className='flex-1 flex flex-col'>
        ...
        <main className='flex-1 flex items-center justify-center px-4 py-10'>
          <div className='w-full max-w-[480px] rounded-2xl border border-border bg-card p-5 sm:p-10 shadow-xl shadow-black/40'>
            ...
            {/* Google Sign-In */}
            <a
              href={`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001'}/api/v1/auth/google?ref=${refCode || ''}`}
              className='flex h-10 w-full items-center justify-center gap-3 rounded-[--radius-md] border border-border bg-white text-sm font-medium text-gray-800 transition-colors hover:bg-gray-50 disabled:opacity-50'
            >
